#!/usr/bin/env python3
"""
MEDICA Scraper for TÜV-certified Chinese companies
Scrapes companies from: https://www.medica-tradefair.com/vis/v1/en/search?_query=TUV&f_country=CN
"""
...
def exhibitor_already_scraped(exhibitor_name, base_dir="downloads_tuv"):
...
def scrape_modal_data(page, exhibitor_name, exhibitor_dir):
    ...
    exhibitor_data = {
        ...
        "event": "MEDICA 2025",
        "has_tuv": True,       # Flag to indicate TÜV certification
        "scraped_at": None
    }
...
def run():
    base_download_dir = "downloads_tuv"
    ...
    with sync_playwright() as p:
        ...
        # Start with the TÜV search URL directly (already has China filter applied)
        url = "https://www.medica-tradefair.com/vis/v1/en/search?_query=TUV&f_country=CN"
        print(f"\n{'='*70}")
        print(f"MEDICA TÜV SCRAPER - Chinese Companies")
        print(f"{'='*70}")
        print(f"\nNavigating to {url}\n")
        ...
        while True:
            ...
            print(f"Found {len(items)} exhibitor cards on this page.\n")
        ...
        with open(csv_file, "w", encoding="utf-8", newline="") as f:
            ...
            for exhibitor in all_exhibitors:
                writer.writerow({
                    ...
                    "has_tuv": exhibitor.get("has_tuv", True),
