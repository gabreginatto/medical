...
SELECT
    ...
    CASE
        WHEN t.lacre_items_count = t.total_items THEN 'Pure Lacre Tender'
        WHEN t.lacre_items_count > 0 AND t.lacre_items_count < t.total_items THEN 'Mixed Tender'
        ELSE 'Unknown'
    END as tender_type
...
WHERE ti.is_lacre = TRUE  -- Only show lacre items
